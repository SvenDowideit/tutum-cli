...
def service_run(image, name, cpu_shares, memory, memory_swap, privileged, target_num_containers, run_command, 
                entrypoint,container_ports, container_envvars, linked_to_service,  autorestart, autoreplace,
    ...
    try:
        ...
        service = tutum.Service.create(image=image, name=name, cpu_shares=cpu_shares,
                                       memory=memory, memory_swap=memory_swap, privileged=privileged,
